...
- [ ] T027 [P] [US6] Verify the payload against the **two-delta** statement — `schemaLocation` absent, duration wrapped, nothing else moved including key order and the string boolean form — never against unconditional byte-identity; record the diff in `specs/010-consumer-migration/baseline.md` against `specs/010-consumer-migration/contracts/editor-ui-messages.md` (FR-013, SC-005)
