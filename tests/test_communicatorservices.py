...
from cuemsutils.tools.CommunicatorServices import (
    Message, 
    ConnectionInfo, 
    Nng_bus_hub, 
    Nng_request_response, 
    Communicator
)
...
class TestNngBusHub:
    ...
    def test_hub_initialization_controller(self, hub_controller):
    ...
    def test_hub_initialization_node(self, hub_node):
    ...
    def test_send_message_dict(self, hub_controller):
    ...
    def test_send_message_message_object(self, hub_controller):
    ...
    def test_send_message_invalid_type(self, hub_controller):
    ...
    def test_send_message_invalid_message_data(self, hub_controller):
    ...
    def test_get_message(self, hub_controller):
    ...
    def test_get_active_connections(self, hub_controller):
    ...
    def test_get_connection_count(self, hub_controller):
    ...
    def test_connection_health_info_no_activity(self, hub_controller):
    ...
    def test_connection_health_info_with_activity(self, hub_controller):
    ...
    def test_connection_health_info_old_activity(self, hub_controller):
    ...
    def test_enable_disable_auto_ping(self, hub_controller):
    ...
    def test_enable_disable_auto_pong(self, hub_controller):
    ...
    def test_send_ping(self, hub_controller):
    ...
    def test_handle_ping_pong_ping(self, hub_controller):
    ...
    def test_handle_ping_pong_pong(self, hub_controller):
    ...
    def test_handle_ping_pong_non_ping_pong(self, hub_controller):
    ...
    def test_handle_ping_pong_no_type(self, hub_controller):
    ...
    def test_extract_sender_info_tcp(self, hub_controller):
    ...
    def test_extract_sender_info_ipc(self, hub_controller):
    ...
    def test_extract_sender_info_unknown(self, hub_controller):
    ...
    def test_add_callbacks(self, hub_controller):
    ...
    def test_post_connect_callback(self, hub_controller):
    ...
    def test_post_remove_callback(self, hub_controller):
...
class TestCommunicator:
    ...
    def test_initialization_with_custom_service(self):
        ...
        with patch('cuemsutils.tools.CommunicatorServices.check_path'):
            comm = Communicator("/tmp/test.sock", communicator_service=mock_service, nng_mode=False)
            
            assert comm.address == "ipc:///tmp/test.sock"
            assert comm.nng_mode == False
